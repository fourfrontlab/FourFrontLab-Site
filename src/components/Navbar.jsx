  ...
  return (
    <nav className="sticky top-0 left-0 right-0 z-50 bg-[#FAFAF8]/95 backdrop-blur-md border-b border-[#151515]">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
        ...
        <Link href="/contact" className="bg-[#FAFAF8] border border-[#151515] text-[#151515] px-5 py-2.5 text-sm font-mono font-bold tracking-widest uppercase hover:bg-[#151515] hover:text-[#FAFAF8] transition-all corner-ticks">
          Start a Project
        </Link>
      </div>
    </nav>
