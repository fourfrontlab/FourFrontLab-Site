...
export default function Founders() {
  ...
  return (
    <section className="py-32 md:py-40 px-6 lg:px-12 max-w-[1400px] mx-auto border-b border-zinc-900 overflow-hidden" id="team" ref={containerRef}>
      <div className="mb-24 max-w-3xl">
        <h2 className="founder-header text-5xl lg:text-7xl font-medium tracking-tighter leading-none mb-10 text-white">The Four Fronts.</h2>
        <p className="founder-header text-zinc-300 text-xl lg:text-2xl leading-relaxed mb-6 font-light">
        ...
        <p className="founder-header text-zinc-300 text-xl lg:text-2xl leading-relaxed font-light">
      ...
      <div className="founders-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="founder-card group cursor-pointer">
          <div className="w-full aspect-[4/5] bg-zinc-900 rounded-sm mb-6 overflow-hidden relative border border-zinc-800">
             ...
             {/* Glow on hover */}
             <div className="absolute inset-0 bg-[#CCFF00]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
          </div>
          <h3 className="text-2xl font-medium text-white mb-2 group-hover:text-[#CCFF00] transition-colors">Muhammad Taha Nadeem</h3>
          <span className="font-mono text-[#CCFF00] text-xs uppercase tracking-widest block mb-4">Frontend / Engineering</span>
        ...
        <div className="founder-card group cursor-pointer lg:translate-y-8">
          ...
          <h3 className="text-2xl font-medium text-white mb-2 group-hover:text-[#CCFF00] transition-colors">Abdul Haseeb</h3>
          <span className="font-mono text-[#CCFF00] text-xs uppercase tracking-widest block mb-4">Backend / Architecture</span>
          <div className="flex gap-4">
        ...
        <div className="founder-card group cursor-pointer lg:translate-y-16">
          ...
          <h3 className="text-2xl font-medium text-white mb-2 group-hover:text-[#CCFF00] transition-colors">Syed Haseeb Badshah</h3>
          <span className="font-mono text-[#CCFF00] text-xs uppercase tracking-widest block mb-4">UX/UI / Design System</span>
          <div className="flex gap-4">
        ...
        <div className="founder-card group cursor-pointer lg:translate-y-24">
          ...
          <h3 className="text-2xl font-medium text-white mb-2 group-hover:text-[#CCFF00] transition-colors">Mustafa Arfat</h3>
          <span className="font-mono text-[#CCFF00] text-xs uppercase tracking-widest block mb-4">Strategy / Growth</span>
          <div className="flex gap-4">
