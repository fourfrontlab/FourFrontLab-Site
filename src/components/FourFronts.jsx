    ...
    <section ref={sectionRef} className="md:h-screen w-full overflow-hidden bg-[#F0F1F3] flex items-stretch relative border-b border-[#E0E2E5]">
      ...
      <div ref={scrollContainerRef} className="flex flex-col md:flex-row h-auto md:h-full w-full md:w-[200%] shrink-0 relative z-10">
        ...
        <div className="front-panel w-full md:w-1/4 h-auto md:h-full min-h-[70vh] flex flex-col justify-between py-12 md:py-16 px-8 md:px-12 relative gap-8 border-b md:border-b-0 md:border-r border-[#E0E2E5]">
          ...
          <div className="w-full max-w-[400px] h-[320px] mx-auto border border-[#E0E2E5] bg-[#FAFAFA] shadow-sm rounded-sm p-4 flex flex-col relative overflow-hidden group">
            {/* Top Bar */}
            <div className="w-full h-8 border-b border-[#E0E2E5] flex items-center px-2 gap-2 mb-4">
            ...
            <div className="flex gap-4 h-full">
              {/* Sidebar */}
              <div className="w-1/4 h-full flex flex-col gap-3 border-r border-[#E0E2E5] pr-4">
                <div className="w-full h-3 bg-[#0E5C8C]/20 rounded-full" />
                <div className="w-3/4 h-3 bg-[#E0E2E5] rounded-full" />
                <div className="w-5/6 h-3 bg-[#E0E2E5] rounded-full" />
                <div className="w-2/3 h-3 bg-[#E0E2E5] rounded-full" />
              </div>
              ...
              <div className="flex-1 flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                  <div className="flex-1 h-16 bg-white border border-[#E0E2E5] rounded-sm p-2 flex flex-col justify-between group-hover:border-[#0E5C8C]/30 transition-colors">
                    <div className="w-8 h-2 bg-[#E0E2E5] rounded-full" />
                    <div className="w-12 h-4 bg-[#0E5C8C]/80 rounded-full group-hover:w-16 transition-all duration-700" />
                  </div>
                  <div className="flex-1 h-16 bg-white border border-[#E0E2E5] rounded-sm p-2 flex flex-col justify-between group-hover:border-[#2BA9D1]/30 transition-colors delay-100">
                    <div className="w-8 h-2 bg-[#E0E2E5] rounded-full" />
                    <div className="w-16 h-4 bg-[#2BA9D1]/80 rounded-full group-hover:w-20 transition-all duration-700 delay-100" />
                  </div>
                </div>
                
                {/* Large card */}
                <div className="w-full flex-1 bg-white border border-[#E0E2E5] rounded-sm p-4 relative overflow-hidden">
                  <div className="w-24 h-3 bg-[#E0E2E5] rounded-full mb-6" />
                  {/* Mock graph lines */}
                  <div className="absolute bottom-0 left-0 w-full h-1/2 flex items-end gap-1 px-4 opacity-50 pb-4">
        ...
        <div className="front-panel w-full md:w-1/4 h-auto md:h-full min-h-[70vh] flex flex-col justify-between py-12 md:py-16 px-8 md:px-12 relative gap-8 border-b md:border-b-0 md:border-r border-[#E0E2E5]">
          ...
          <div className="w-full max-w-[400px] h-[320px] mx-auto border border-[#E0E2E5] bg-[#FAFAFA] shadow-sm rounded-sm p-6 font-mono text-sm text-[#5A5A5A] relative overflow-hidden flex flex-col">
        ...
        <div className="front-panel w-full md:w-1/4 h-auto md:h-full min-h-[70vh] flex flex-col justify-between py-12 md:py-16 px-8 md:px-12 relative gap-8 border-b md:border-b-0 md:border-r border-[#E0E2E5]">
          ...
          <div className="w-full max-w-[400px] h-[320px] mx-auto border border-[#E0E2E5] bg-[#FAFAFA] shadow-sm rounded-sm p-8 relative flex items-center justify-center group overflow-hidden">
            {/* Phone outline */}
            <div className="w-40 h-[240px] bg-white border-[6px] border-[#1A1A1A] rounded-3xl p-3 shadow-sm relative flex flex-col gap-2 group-hover:-translate-y-2 group-hover:shadow-xl transition-all duration-700">
              {/* Notch */}
              <div className="w-12 h-3 bg-[#1A1A1A] rounded-b-lg mx-auto absolute top-0 left-1/2 -translate-x-1/2" />
              
              {/* UI Elements */}
              <div className="w-full h-10 bg-[#0E5C8C]/10 rounded-lg mt-3" />
              <div className="w-3/4 h-3 bg-[#E0E2E5] rounded-full" />
              <div className="w-1/2 h-3 bg-[#E0E2E5] rounded-full mb-1" />
              
              <div className="flex gap-2">
                <div className="w-1/2 h-16 bg-[#2BA9D1]/10 rounded-lg group-hover:bg-[#2BA9D1]/20 transition-colors" />
                <div className="w-1/2 h-16 bg-[#2BA9D1]/10 rounded-lg" />
              </div>

              {/* CTA Button */}
              <div className="w-full h-8 bg-[#0E5C8C] rounded-full mt-auto relative overflow-hidden group-hover:scale-[0.98] transition-transform">
        ...
        <div className="front-panel w-full md:w-1/4 h-auto md:h-full min-h-[70vh] flex flex-col justify-between py-12 md:py-16 px-8 md:px-12 relative gap-8">
          ...
          <div className="w-full max-w-[400px] h-[320px] mx-auto border border-[#E0E2E5] bg-[#FAFAFA] shadow-sm rounded-sm p-6 relative flex flex-col overflow-hidden group">
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                <div className="text-xs font-mono text-[#5A5A5A] uppercase tracking-widest mb-1">Growth Metrics</div>
                <div className="text-2xl font-bold font-space text-[#1A1A1A] group-hover:text-[#0E5C8C] transition-colors">+248%</div>
              </div>
              <div className="px-3 py-1 bg-green-100 text-green-700 text-xs font-bold rounded-full animate-pulse">LIVE</div>
            </div>
            
            {/* Chart Area */}
            <div className="flex-1 relative border-l border-b border-[#E0E2E5] flex items-end justify-between pt-8 pb-0 px-2 gap-2">
              {/* Grid lines */}
              ...
              <div className="w-full bg-[#2BA9D1]/20 rounded-t-sm h-[40%] group-hover:h-[85%] transition-all duration-1000 delay-300 relative group-hover:bg-[#2BA9D1]/40">
                ...
                <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#1A1A1A] text-white text-[10px] font-mono px-2 py-1 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-1000 whitespace-nowrap">
                  Target Hit
                </div>
              </div>
            </div>
