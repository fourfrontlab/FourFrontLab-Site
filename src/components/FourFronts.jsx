...
export default function FourFronts() {
  ...
  return (
    <section ref={sectionRef} className="h-screen w-full overflow-hidden bg-[#F0F1F3] flex items-center relative border-b border-[#E0E2E5]">
      {/* Background Accent */}
      ...
      <div ref={scrollContainerRef} className="flex h-full w-[400%] relative z-10">
        ...
        {/* Panel 1: Frontend */}
        <div className="front-panel w-1/4 h-full flex flex-col md:flex-row items-center justify-center py-8 lg:py-24 px-8 md:px-12 lg:px-12 relative gap-8 lg:gap-16 border-r border-[#E0E2E5]">
          <div className="flex-1 z-10 w-full lg:pl-20 xl:pl-32 lg:pr-8">
            ...
            <h2 className="text-5xl lg:text-7xl font-bold tracking-tighter leading-none mb-8 font-space text-[#1A1A1A]">Pixel-perfect<br />precision.</h2>
          ...
          <div className="flex-1 h-[50vh] w-full border border-[#E0E2E5] bg-[#FAFAFA] shadow-sm rounded-sm p-8 flex flex-col gap-4 relative overflow-hidden group">
        ...
        <div className="front-panel w-1/4 h-full flex flex-col md:flex-row items-center justify-center py-8 lg:py-24 px-8 md:px-12 lg:px-12 relative gap-8 lg:gap-16 border-r border-[#E0E2E5]">
          <div className="flex-1 z-10 w-full lg:pl-20 xl:pl-32 lg:pr-8">
            ...
            <h2 className="text-5xl lg:text-7xl font-bold tracking-tighter leading-none mb-8 font-space text-[#1A1A1A]">Invisible<br />power.</h2>
          ...
          <div className="flex-1 h-[50vh] w-full border border-[#E0E2E5] bg-[#FAFAFA] shadow-sm rounded-sm p-6 font-mono text-sm text-[#5A5A5A] relative overflow-hidden flex flex-col">
            ...
            <div className="group-hover:text-[#1A1A1A] transition-colors">
              ...
              <p className="text-[#2BA9D1] my-2">[SUCCESS] Connection established in 42ms</p>
        ...
        <div className="front-panel w-1/4 h-full flex flex-col md:flex-row items-center justify-center py-8 lg:py-24 px-8 md:px-12 lg:px-12 relative gap-8 lg:gap-16 border-r border-[#E0E2E5]">
          <div className="flex-1 z-10 w-full lg:pl-20 xl:pl-32 lg:pr-8">
            ...
            <h2 className="text-5xl lg:text-7xl font-bold tracking-tighter leading-none mb-8 font-space text-[#1A1A1A]">Logical<br />flow.</h2>
          ...
          <div className="flex-1 h-[50vh] w-full border border-[#E0E2E5] bg-[#FAFAFA] shadow-sm rounded-sm p-8 relative flex items-center justify-center group overflow-hidden">
        ...
        <div className="front-panel w-1/4 h-full flex flex-col md:flex-row items-center justify-center py-8 lg:py-24 px-8 md:px-12 lg:px-12 relative gap-8 lg:gap-16">
          <div className="flex-1 z-10 w-full lg:pl-20 xl:pl-32 lg:pr-8">
            ...
            <h2 className="text-5xl lg:text-7xl font-bold tracking-tighter leading-none mb-8 font-space text-[#1A1A1A]">Measured<br />impact.</h2>
          ...
          <div className="flex-1 h-[50vh] w-full border border-[#E0E2E5] bg-[#FAFAFA] shadow-sm rounded-sm p-8 relative flex items-end gap-4 overflow-hidden group">
